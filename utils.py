...
import parser
from model import ft_net, two_view_net, three_view_net, two_view_net_swin, two_view_net_swin_infonce, two_view_net_swinB_infonce, two_view_net_swin_infonce_plpn
...
def load_network(name, opt):
    ...
    model = two_view_net_swin_infonce_plpn(opt.nclasses, opt.droprate, stride = opt.stride, pool = opt.pool, LPN = True, block=opt.block)
    # load model
