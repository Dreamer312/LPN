...
class VIGOR(torch.utils.data.Dataset):
    def __init__(self, mode = '', root = '/home/minghach/Data/CMH/LPN/dataset/vigor', same_area=True, print_bool=False, polar = '', args=None):
    ...
    def __len__(self):
        if 'train' in self.mode:
            print(f"train_sat_cover_list {len(self.train_sat_cover_list)}")
