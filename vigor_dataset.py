...
class TrainDataloader(Dataset):
    def __init__(self, dir):
        ...
        self.img_grd_size=[320,640]
        self.img_sat_size=[320,320]
        ...
        for city in self.train_city_list:
            ...
            ###############################################
            #print(f"path: {train_sat_list_fname}") 
            # /home/minghach/Data/CMH/LPN/dataset/vigor/splits_corrected/NewYork/satellite_list.txt
            # /home/minghach/Data/CMH/LPN/dataset/vigor/splits__corrected/NewYork/satellite_list.txt
            ###############################################
        ...
        for city in self.train_city_list:
            ...
            with open(train_label_fname, 'r') as file:
                for line in file.readlines():
                    ...
                    # ################################
                    #print(data)
                    txt_len = data.shape[0]
                    #print(f'txt记录的长度是:{txt_len}') #记录的长度是:(13,)

                    if txt_len < 13:
                        print(data)
                    
                    # ['rTW64elYRVtD5DWJ9kBgnA,40.731011,-73.995289,.jpg'
                    # 'satellite_40.7309416656_-73.9953203614.png' '-68.0' '-23.0'
                    # 'satellite_40.7312697381_-73.9953203614.png' '253.0' '-26.0'
                    # 'satellite_40.7309416656_-73.99488735.png' '-65.0' '300.0'
                    # 'satellite_40.7312697381_-73.99488735.png' '257.0' '297.0\n']
                    # 1,4,7,10 are coressponding satellite images
                    ################################
                    label = []
                    for i in [1, 4, 7, 10]:
