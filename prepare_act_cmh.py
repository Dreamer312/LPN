...
img_root = '/home/minghach/Data/CMH/LPN/dataset/cvact/ANU_data_small/'
...
d_train_dir = '/home/minghach/Data/CMH/LPN/dataset/cvact/train_new'
for m in tqdm(range(trainNum)):
    ...
    if os.path.exists(s_str_dir) and os.path.exists(s_sat_dir):
        ...
        shutil.copyfile(s_str_dir,os.path.join(d_str_dir,str_name))
    else:
...
d_val_dir = '/home/minghach/Data/CMH/LPN/dataset/cvact/val_new'
for m in tqdm(range(valNum)):
