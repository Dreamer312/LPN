...
class SwinEncoderOutput(ModelOutput):
    ...
    # hidden_states_before_downsample = None
    
    
    #========================================
   
    # def __init__(self, hidden_states_before_downsample = None):
    #     super(SwinEncoderOutput, self).__init__()
    #     self.hidden_states_before_downsample = hidden_states_before_downsample
    #========================================
...
class SwinStage(nn.Module):
    ...
    def forward(
        ...
        if self.downsample is not None:
            ...
            #=============================================================================
            hidden_states_before_downsample = hidden_states
            #=============================================================================
        ...
        #=============================================================================
        # print(hidden_states_before_downsample.size())
        # print(hidden_states.size())
        # torch.Size([8, 4096, 96])
        # torch.Size([8, 1024, 192])

        
        stage_outputs = (hidden_states, output_dimensions, hidden_states_before_downsample)
        #=============================================================================
...
#========================================================================================
class SwinStageLast(nn.Module):
    def __init__(self, config, dim = 768, input_resolution=(16,16), depth=1, num_heads= 24):
        super().__init__()
        self.config = config
        self.dim = dim
        self.blocks = nn.ModuleList(
    ...
    def forward(
        self,
        hidden_states: torch.Tensor,
        input_dimensions: Tuple[int, int] = (16,16),
        head_mask: Optional[torch.FloatTensor] = None,
        output_attentions: Optional[bool] = False,
    ) -> Tuple[torch.Tensor]:
        height, width = input_dimensions
...
class SwinEncoder(nn.Module):
    ...
    def forward(
        ...
        for i, layer_module in enumerate(self.layers):
            ...
            #================================================================
            hidden_states_before_downsample = layer_outputs[2]
            #================================================================
            ...
            if output_hidden_states:
                ...
                #================================================================
                all_hidden_states_before_downsample += (hidden_states_before_downsample,)
                #================================================================
        ...
        return SwinEncoderOutput(
            ...
            #================================================================
            # hidden_states_before_downsample = all_hidden_states_before_downsample
            #================================================================
        ), all_hidden_states_before_downsample
...
class SwinModel(SwinPreTrainedModel):
    ...
    def forward(
        ...
        encoder_outputs, hs_bf_ds = self.encoder(
            embedding_output,
            input_dimensions,
            head_mask=head_mask,
...
if __name__ == '__main__':
    ...
    input2 = torch.rand((8, 3, 256, 256), dtype=torch.float)
    ...
    # # print(output[0].size())
    # # print(len(output[3]))
    # # print(output[3][3].size())
   
    # last_hidden_states = output.last_hidden_state
    # print(last_hidden_states.equal(output[0]))
    
    
    # reshape_stage4 = output[3][-1].reshape(-1, 768, 64).transpose(2, 1)
    # print(reshape_stage4.size())

    
    # for hidden in output[2]:
    #     print(hidden.size())
    #     print(hidden.equal(reshape_stage4))

    # configuration1 = SwinConfig(image_size=(256, 256), output_hidden_states=True, depths = [1], num_heads = [24])
    # model1 = SwinStageLast(configuration1)
    # output1 = model1(input3)
    
    # print(model1)
    
    # print(output1[3].size())